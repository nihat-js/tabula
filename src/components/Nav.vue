  ...
  <div class="main-header-wrapper1 inner-main-header float_left">
    <div class="right-sidebar" id="right-sidebar">
      <div class="toggle-top-header">
        <a class="tog-logo" href="javascript:;"> <img src="@/assets/images/index1-logo.png" alt="logo"> </a>
      ...
      <div class="post-toggle float_left">
        <div class="togle-img">
          <img src="@/assets/images/drive.png" alt="img">
        </div>
      ...
      <div class="post-toggle float_left">
        <div class="togle-img">
          <img src="@/assets/images/drive1.png" alt="img">
        </div>
        <div class="togle-text">
      ...
      <div class="post-toggle float_left">
        <div class="togle-img">
          <img src="@/assets/images/drive2.png" alt="post">
        </div>
        <div class="togle-text">
      ...
      <div class="tog-social float_left">
        <ul>
          <li>
            <a href="javascript:;"> <span> <svg viewBox="0 0 25 48" version="1.1" xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <a href="javascript:;"> <span><svg version="1.1" id="Capa_13" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="sb-main-header1">
          ...
          <div class="row">
            <div class="col-lg-8 col-md-6">
              <div class="index1-logo">
                <a href="index.html">
                  <img class="normal-logo" src="@/assets/images/blue-logo.png" alt="logo">
                  <img class="sticky-logo" src="@/assets/images/index1-logo.png" alt="logo">
                </a>
              </div>
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item menu-click ps-rel">
                    ...
                    <ul class="dropdown-items menu-open">
                      <li><a href="javascript:;">Freelancer <span><i class="fas fa-chevron-right"></i></span></a>
                      ...
                      <li><a href="javascript:;">Employers <span><i class="fas fa-chevron-right"></i></span></a>
                        <ul class="sub-dropdown">
                      ...
                      <li><a href="javascript:;">Project <span><i class="fas fa-chevron-right"></i></span></a>
                        <ul class="sub-dropdown">
                  ...
                  <li class="nav-item menu-click2 ps-rel">
                    ...
                    <ul class="dropdown-items menu-open2">
                      <li><a href="javascript:;">Blog Category <span><i class="fas fa-chevron-right"></i></span></a>
                        <ul class="sub-dropdown">
                      ...
                      <li><a href="javascript:;"> Blog Single <span><i class="fas fa-chevron-right"></i></span></a>
                        <ul class="sub-dropdown">
            ...
            <div class="col-lg-4 col-md-6">
              <ul
                ...
                <li class="login-btn">
                  ...
                  <div class="user-text">
                    <a href="login.html"> <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
                    ...
                    <a href="sign-up.html"> <span><svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 16 16">
                ...
                <li>
                  <a href="javascript:;" class="sidebar-toggle">
                    <span><svg version="1.1" id="Layer_21" xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="post-drop">
                  <a class="post-btn" href="javascript:;"><span><!-- <i class="fas fa-plus-circle"></i>   --> Post Now
          ...
          <div class="row">
            <div class=" col-md-4 col-sm-4 col-4">
              <div class="mobile-logo">
                <a href="">
                  <img src="@/assets/images/index1-logo.png" alt="logo">
                </a>
              </div>
            </div>
                ...
                <div class="social-media-icons">
                  <ul>
                    <li class="login-btn">
                      <a href="javascript:;"><i class="fa fa-user-o" aria-hidden="true"></i></a>
                      <div class="user-text">
                        <a href="login.html"> <span><svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 16 16">
                        ...
                        <a href="sign-up.html"> <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
                              style="enable-background:new 0 0 32 32" xml:space="preserve">
                              <path
                                d="M16 14c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm0-12c-2.757 0-5 2.243-5 5s2.243 5 5 5 5-2.243 5-5-2.243-5-5-5zM23.942 32H8.058A4.062 4.062 0 0 1 4 27.942c0-6.616 5.383-12 12-12s12 5.384 12 12A4.062 4.062 0 0 1 23.942 32zM16 17.942c-5.514 0-10 4.486-10 10A2.06 2.06 0 0 0 8.058 30h15.884A2.06 2.06 0 0 0 26 27.942c0-5.514-4.486-10-10-10z">
                              </path>
      ...
      <div id="sidebar">
        <div class="sidebar_logo">
          <a href="index.html"><img src="@/assets/images/index1-logo.png" alt="logo"></a>
        </div>
        ...
        <div id='cssmenu'>
          <ul class="float_left">
            ...
            <li class="has-sub"><a href="javascript:;">Service</a>
              <ul>
                <li class="has-sub">
            ...
            <li class="has-sub"><a href="javascript:;">Pages</a>
              <ul>
                <li><a href="post-jobs.html">Post A Job</a></li>

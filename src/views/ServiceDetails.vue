          ...
          <div class="col-lg-3 col-md-3 col-sm-4 col-12">
            <div class="profile-photo float_left">
              <div class="small-12 medium-2 large-2 columns">
                <div class="circle">
                  <!-- User Profile Image -->
                  <img class="profile-pic" src="@/assets/images/pro.jpg" alt="img">
                </div>
                <div class="p-image">
          ...
          <div class="col-lg-3 col-md-3 col-12">
            <div class="project-box float_left">
              <div class="project-line float_left">
                <div class="pro-icon">
                  <img src="@/assets/images/p-icon1.png" alt="img">
                </div>
                <div class="pro-desc">
                  <h2>07</h2>
              ...
              <div class="project-line float_left">
                <div class="pro-icon">
                  <img src="@/assets/images/p-icon2.png" alt="img">
                </div>
                <div class="pro-desc">
                  <h2>00</h2>
              ...
              <div class="project-line float_left">
                <div class="pro-icon">
                  <img src="@/assets/images/p-icon3.png" alt="img">
                </div>
                <div class="pro-desc">
                  <h2>240</h2>
              ...
              <div class="project-line line-none float_left">
                <div class="pro-icon">
                  <img src="@/assets/images/p-icon4.png" alt="img">
                </div>
                <div class="pro-desc">
                  <h2>$540.00</h2>
                  <p>Total Earnings</p>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port1.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_11" viewBox="0 0 128 128"
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port2.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_12" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port3.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_13" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port4.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_14" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port5.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_15" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port6.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_16" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port7.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_17" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port8.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_18" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port9.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_19" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box float_left">
                <img src="@/assets/images/port10.png" alt="img">
                <div class="overlay-port">
                  <span><svg data-name="Livello 1" id="Livello_20" viewBox="0 0 128 128"
                      xmlns="http://www.w3.org/2000/svg">
                      <title />
                      <path
                        d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="portfolio-box-blank float_left">
                <span><svg data-name="Livello 1" id="Livello_21" viewBox="0 0 128 128"
                    xmlns="http://www.w3.org/2000/svg">
                    <title />
                    <path
                      d="M64,0a64,64,0,1,0,64,64A64.07,64.07,0,0,0,64,0Zm0,122a58,58,0,1,1,58-58A58.07,58.07,0,0,1,64,122Z" />
      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-12">
          <div class="inner_widget float_left mt-4 mb-4">
            ...
            <div class="review-box float_left">
              ...
              <div class="review-text">
                ...
                <div class="review-name">
                  <p>Michael G</p>
                  <span> <img src="@/assets/images/india.png" alt="img"> 3 days ago</span>
                </div>
            ...
            <div class="review-box float_left">
              <div class="review-img">
                <img src="@/assets/images/profile2.png" alt="img">
              </div>
              <div class="review-text">
                <a href="javascript:;">
                  <h4>UI / UX PSD Design for Job</h4>
                </a>
                <div class="star-review">
                  <p>3.5/5</p>
                  <ul class="review-profile">
            ...
            <div class="review-box float_left">
              <div class="review-img">
                <img src="@/assets/images/profile3.png" alt="img">
              </div>
              <div class="review-text">
                <a href="javascript:;">
                  <h4>Application Landing Page Design </h4>
                </a>
                <div class="star-review">
                  <p>3.5/5</p>
                  <ul class="review-profile">
            ...
            <div class="review-box float_left">
              <div class="review-img">
                <img src="@/assets/images/profile4.png" alt="img">
              </div>
              <div class="review-text">
                <a href="javascript:;">
                  <h4>Project for Charlie Martin</h4>
                </a>
                <div class="star-review">
                  <p>3.5/5</p>
                  <ul class="review-profile">
        ...
        <div class="col-lg-4 col-md-4 col-12">
          ...
          <div class="inner_widget float_left mb-4">
            ...
            <div class="skill-inner pt-0 float_left">
              <div class="post-img">
                <img src="@/assets/images/post2.png" alt="post">
              </div>
              <div class="post-cont">
                <h6>Best Logo Design Winner</h6>
                <span>July 21, 2022</span>
            ...
            <div class="skill-inner pt-0 float_left">
              <div class="post-img">
                <img src="@/assets/images/post3.png" alt="post">
              </div>
              <div class="post-cont">
                <h6>Best Logo Design Winner</h6>
                <span>July 21, 2022</span>
          ...
          <div class="inner-page-main-wrapper mt-0 mb-0 float_left">
            <div class="side-bar-social float_left">
              <ul>
                ...
                <li>
                  <a href="javascript:;"> <span><svg version="1.1" id="Capa_22" xmlns="http://www.w3.org/2000/svg"
                      ...
                      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g>
                          <g>
                            <g>
                              <path class="st0"
                                d="M288.7727,379.6177c-31.0821-2.4047-44.1417-17.8159-68.517-32.6133
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="sb-footer-section">
            <div class="footer-logo">
              <a href="index.html"><img src="@/assets/images/index1-logo.png" alt=""></a>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="links">
            ...
            <div class="app-btn">
              ...
              <a href="javascript:;">
                <img src="@/assets/images/gpay.png" alt="app">
              </a>
            </div>
          </div>
        </div>
  ...
  <div class="hire_me_popup" id="hire" style="display: none;">
    <div class="hire_me_popup_box">
      ...
      <form>
        ...
        <textarea
          rows="3">Hi kingjoon, I noticed your profile and would like to offer you my project. We can discuss any details over chat.</textarea>
        ...
        <p>By clicking "Hire Now", you are indicating that you have read and agree to the <a
            href="terms_service.html">Terms & Conditions</a> and <a href="privacy_policy.html">Privacy Policy</a></p>
